...
const BUILTIN_DEFAULTS: ConfigStoreState = {
    ...
    weather_x: 50,
    weather_y: 50,
    weather_hourly_enabled: true,
    weather_hourly_interval: 20,
    weather_hourly_pop: true,
    weather_hourly_temp: true,
    weather_hourly_humidity: false,
    weather_hourly_windspeed: false,
    weather_hourly_pressure: false,
    weather_hourly_cloud: false,
    weather_hourly_precip: false,
    weather_hourly_dew: false,
    weather_hourly_windlv: false,
    ...
    server_mode: false,
    global_yakeli_enabled: false,
    global_yakelicolor: [0, 0, 0] as [number, number, number],
    global_yakeli: 0.3,
    global_bluryakeli: 10,
    global_yakeli_roundedcorners: 12,

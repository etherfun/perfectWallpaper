...
const BUILTIN_DEFAULTS: ConfigStoreState = {
    ...
    showSakura: true,
    sakura_transparency: 0.8,
    sakura_background: false,
    sakura_back_color: true,
    sakura_reverse: false,
    sakura_point_number: 100,
    sakura_back_light: 0.5,
    ...
    fluid_effect_resolution: 256,
    fluid_effect_blur_amount: 20,
    fluid_effect_displacement_scale: 25,
    fluid_effect_turbulence_octaves: 8,
    fluid_effect_canvas_displacement: 50,
    fluid_effect_dark_overlay_strength: 30,
    ...
    particles_opacity_random: true,
    particles_color: [255, 255, 255] as [number, number, number],
    particles_shadow_color: [255, 255, 255] as [number, number, number],
    particles_shadow_blur: 0,
    particles_image: '',
    particles_shape_type: 1,
    map_route: 'map/snowflake.png',
    particles_size_value: 3,
    particles_size_random: true,
    particles_link_enable: true,
    particles_link_distance: 100,

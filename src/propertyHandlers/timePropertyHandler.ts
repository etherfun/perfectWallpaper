...
export function handleTimeProperties(
    ...
    if (properties.oclock_blurcolor_show) {
        ...
        elements.body.style.setProperty("--clock-blur-enabled", config.oclock_blurcolor_show ? '1' : '0');
    }
    ...
    if (properties.oclock_yakeli_show) {
        ...
        elements.body.style.setProperty("--clock-yakeli-enabled", config.oclock_yakeli_show ? '1' : '0');
    }
    ...
    if (properties.oclock_bluryakeli) {
        ...
        elements.body.style.setProperty("--clock-blur-yakeli", String(config.oclock_bluryakeli) + 'px');
    }

...
function buildDateString(
    ...
    if (config.date_format.order === 1) {
        ...
        if (month) {
            parts.push(month);
            partTypes.push('month');
        }
        if (day) {
            parts.push(day);
            partTypes.push('day');
        }
    } else if (config.date_format.order === 2) {
        // 月日年顺序
        if (month) {
            parts.push(month);
            partTypes.push('month');
    ...
    } else if (config.date_format.order === 3) {
        // 日月年顺序
        if (day) {
            parts.push(day);
            partTypes.push('day');
